...
| 4 | In progress (diagnostic foundation implemented 2026-09-21) | Added `diagnose_virtual_machine` with bounded VM status, optional metrics, Advisor evidence, explicit observation/inference separation, incomplete-evidence reporting, tests, and MCP registration | AKS, Functions, SQL, Cosmos, Azure ML tools and opt-in integration checks remain |
| 5 | Not started | - | - |
